...
Rectangle {
    ...
    Text {
        ...
        color: "#ffffff"
        text: "If you are new to Lumeneo, choose \"Create a new wallet\"."
    ...
    Rectangle {
        ...
        Text {
         ...
         Text {
            ...
            color: "#999999"
            text: "Enter the approximate height (block number) you created your wallet at. Massively speeds up wallet sync. Leave 0 is unsure."
