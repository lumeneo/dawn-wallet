...
Dialog {
    ...
    property var addressDev: "darkjwUGb5seYKVd2pB45ND78quwLKaaGAJPZp8yeDKdXWPDpBaCaZU54mxuEKemqn7mUpTQ6QDiHJKuQyVbk7mB4srHa36Ks1"
    property var websiteChat: "https://discord.gg/QkbWQ3x"
    property var versionDawn: ""
    property var newVersionDawnAvailable: ""
    property var urlNewVersionDawn: ""
    ...
    Text {
        ...
        font.family: "Arial"
        font.pixelSize: 13
        anchors.horizontalCenter: textDawn.horizontalCenter
        anchors.top: textDawn.bottom
        anchors.topMargin: 5
    }
    ...
    Rectangle {
        ...
        Text {
            id: textNewVersion
            text: "New version (v. " + newVersionDawnAvailable + ") is available. Download here"
            font.family: "Arial"
            font.pixelSize: 13
            font.bold: true
            anchors.horizontalCenter: parent.horizontalCenter
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {
                    QmlBridge.goToWebsite(urlNewVersionDawn);
                }
            }
        }
    }
    ...
    Text {
        ...
        text: "Donate to support Dawn's dev"
        font.family: "Arial"
        font.pixelSize: 13
    ...
    function show() {
        versionDawn = QmlBridge.getVersion();
        newVersionDawnAvailable = QmlBridge.getNewVersion();
        if (newVersionDawnAvailable != "") {
            rectangleNewVersion.visible = true;
            urlNewVersionDawn = QmlBridge.getNewVersionURL();
        } else {
