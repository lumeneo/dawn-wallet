...
Rectangle {
    ...
    Rectangle {
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive LMO"
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " LMO + " + rectangleTransfer.transferFee + " LMO (fee)", rectangleTransfer.transferPaymentID, rectangleTransfer.transferMixin);
            }
        }
